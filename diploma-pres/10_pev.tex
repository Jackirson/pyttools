	...
	%\includegraphics[width=0.8\linewidth]{./pic/globalscheme}
 	\begin{columns}
 		\column{0.50\textwidth}
 			...
 			есть $m$ параметров. Модель: {\small {\em независимые} неопределённые элементы} 
